...
/**
 * Manual demonstration of the protocol by running 3 representative scenarios,
 * including the corner case of a coordinator crash that triggers a ring election.
 * The protocol's key steps are printed by the {@link Logger}.
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (ActorRef r : replicas.values()) {
            r.tell(initMsg, ActorRef.noSender());
        }
